...
export default function About() {
  ...
  return (
    <div
      className="bg-cover fixed w-full"
    ...
    >
      ...
      <div className="">
        ...
        <div className="p-6 h-screen text-[#383838] md:flex md:justify-center">
          <div className="flex flex-col h-3/4 justify-evenly md:w-2/4 items-center md:justify-between mt-10">
            <h1 className="text-5xl font-libre font-bold md:text-6xl">
              About Us
            </h1>
            <p className="leading-relaxed font-libre text-sm md:text-lg lg:text-xl md:leading-loose flex flex-col gap-y-1">
              <p>{about_content1}</p>
              <br />
              <p>{about_content2}</p>
            </p>
